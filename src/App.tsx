...
const tabCopy: Record<TabKey, { intro: string; boldWord: string }> = {
  pores: {
    intro: 'Μπορείτε να εξισορροπήσετε τη λιπαρότητα και να ελαχιστοποιήσετε τους',
    boldWord: 'πόρους',
  },
  wrinkles: {
    intro: 'Μπορείτε να ενεργοποιήσετε ξανά την παραγωγή κολλαγόνου και να μειώσετε ορατά τις',
    boldWord: 'ρυτίδες',
  },
  dark_circles: {
    intro: 'Μπορείτε να επαναφέρετε το φωτεινό, ξεκούραστο',
    boldWord: 'βλέμμα',
  },
  dehydration: {
    intro: 'Μπορείτε να ανακτήσετε τη φυσική λάμψη και να αναπλάσετε το πρόσωπο σας σε',
    boldWord: 'βάθος',
  },
  dark_spots: {
    intro: 'Μπορείτε να στοχεύσετε τη μελανίνη στη ρίζα της και να επαναφέρετε ομοιόμορφο λαμπερό',
    boldWord: 'τόνο',
  },
};
