    ...
    <div style={{ background: '#FAF8F5', minHeight: '100dvh' }}>
      <div style={{ paddingTop: 16, paddingBottom: 16 }}>
        ...
        <p style={{ fontSize: 10, color: '#8B7355', lineHeight: 1.4, fontWeight: 400, margin: '10px 16px 12px' }}>
          Η χρήση αυτού του εργαλείου διέπεται από τους Όρους Χρήσης. Το εργαλείο προορίζεται για γενικές συστάσεις περιποίησης δέρματος και δεν αντικαθιστά επαγγελματικές ιατρικές συμβουλές. Οι εικόνες δεν αποθηκεύονται και διαγράφονται αυτόματα μετά την ανάλυση.
        </p>
